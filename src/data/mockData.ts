export const mockComps = [
...

  {
    ...
    ruler: "Spirit Empress",
    units: ["Bomber", "Executioner", "Spear Goblin", "Goblin Machine", "PEKKA", "Royal Ghost"],
    tier: "A" as const,
    description: "Thrower AoE + Undead curses + sturdy Juggernaut front.",
    descriptionLong:
      "Stacks Thrower, Undead, Goblin, Juggernaut and Ace synergies for overwhelming control. Bomber/Executioner provide AoE, Goblin Machine/P.E.K.K.A tank with Juggernaut shields, and Royal Ghost adds pressure and curses. Once Thrower bonuses kick in, long-range splash takes over.",
    whenToPlay:
      "Great in slower lobbies and when you find early Throwers. Excels into clumped enemies and mid-to-late scaling.",
    coreUnits: ["Executioner", "Goblin Machine", "Royal Ghost"],
    tips: [
      "Place Throwers far back to leverage range/distance bonuses.",
      "Use Goblin units as cheap merge fodder for tempo.",
      "Ghost targets fragile frontlines—mirror enemy carry side."
    ],
    battlefieldUnits: [
      { name: "Bomber",        row: 3, col: 1 },
      { name: "Executioner",   row: 3, col: 3 },
      { name: "Spear Goblin",  row: 3, col: 0 },
