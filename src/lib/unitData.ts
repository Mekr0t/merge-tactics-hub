export const UNIT_DATA: Record<string, { cost: number; traits: string[]; description: string; displayName: string; gender?: string; range?: number }> = {
  ...
  speargoblin: { displayName: "Spear Goblin", cost: 2, traits: ["Goblin", "Blaster"], gender: "Male", range: 3, description: "Spears that slice through wind at such a wide range that he doesn’t even need armor" },
  skeletondragons: { displayName: "Skeleton Dragons", cost: 2, traits: ["Undead", "Ranger"], gender: "Male", range: 4, description: "Splits to create a new Skeleton Dragon after every few attacks" },
  wizard: { displayName: "Wizard", cost: 2, traits: ["Fire", "Mage"], gender: "Male", range: 4, description: "Throws a fireball at enemies in the area" },

  // 3 elixir cost
  valkyrie: { displayName: "Valkyrie", cost: 3, traits: ["Clan", "Juggernaut"], gender: "Female", range: 1, description: "A melee master who channels her rage into area Damage" },
  pekka: { displayName: "P.E.K.K.A", cost: 3, traits: ["Ace", "Avenger"], gender: "Female", range: 1, description: "A slow, but heavily armored melee fighter. Nothing gets past her…" },
  ...
  executioner: { displayName: "Executioner", cost: 3, traits: ["Ace", "Blaster"], gender: "Male", range: 4, description: "Throws his boomerang axe at the nearest target across several Hexes" },
  electrogiant: { displayName: "Electro Giant", cost: 3, traits: ["Electric", "Avenger"], gender: "Male", range: 1, description: "Summons an electric field around himself, dealing damage and stunning nearby enemies every second" },
  musketeer: { displayName: "Musketeer", cost: 3, traits: ["Noble", "Blaster"], gender: "Female", range: 3, description: "A tanky gunner who pushes 3 enemies back every few hits" },
  ...
  bandit: { displayName: "Bandit", cost: 4, traits: ["Ace", "Assassin"], gender: "Female", range: 1, description: "Dashes to the farthest enemy in 3 Hexes after certain hits, dealing bonus Damage and stunning all in her path for 1s" },
  ...
  babydragon: { displayName: "Baby Dragon", cost: 4, traits: ["Fire", "Blaster"], gender: "Male", range: 4, description: "Burps big fireballs that deal damage in a wide area" },
  electrowizard: { displayName: "Electro Wizard", cost: 4, traits: ["Electric", "Mage"], gender: "Male", range: 4, description: "Shoots lightning with his hands, stunning multiple enemies every few seconds" },
